Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ /https:\/\/(.*?)\.dbjohn\.com/, ENV['CORS_ORIGIN'] ]
  ...
  # config.active_job.queue_name_prefix = "dbjohn_api_#{Rails.env}"
  ...
  config.middleware.insert_before 0, Rack::Cors do
    allow do
      origins /http(s)?:\/\/(.*?)\.?dbjohn\.com/, /https:\/\/ember-dbjohn-com\.herokuapp\.com/
